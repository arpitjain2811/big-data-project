...
tip:
	hadoop jar /usr/hdp/2.2.0.0-2041/hadoop-mapreduce/hadoop-streaming-2.6.0.2.2.0.0-2041.jar -files tip/map.py,tip/reduce.py -mapper map.py  -reducer reduce.py -input /user/jx624/FOIL*/trip_fare_*.csv  -output trip_day		